...
async function writeSpecification(): Promise<void> {
  const config = { publicOrigin: "https://notemarkdown.invalid", publicBaseUrl: "https://notemarkdown.invalid/notes", googleClientId: "spec", secureCookies: true } as ApiConfig;
